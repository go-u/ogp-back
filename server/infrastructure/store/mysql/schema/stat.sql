...
# ogpテーブルは定期削除するため、負荷対策/保存目的の集計テーブルを利用
CREATE TABLE stat # stat by fqdn
(
    date        DATE                                NOT NULL,
