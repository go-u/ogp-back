...
type Bookmark struct {
	...
	OgpID     uint      `boil:"ogp_id" json:"ogp_id" toml:"ogp_id" yaml:"ogp_id"`
...
var BookmarkWhere = struct {
	...
	OgpID     whereHelperuint
	CreatedAt whereHelpertime_Time
}{
	ID:        whereHelperuint{field: "`bookmark`.`id`"},
	UserID:    whereHelperuint{field: "`bookmark`.`user_id`"},
	OgpID:     whereHelperuint{field: "`bookmark`.`ogp_id`"},
...
var (
	bookmarkAllColumns            = []string{"id", "user_id", "ogp_id", "created_at"}
	bookmarkColumnsWithoutDefault = []string{"user_id", "ogp_id", "created_at"}
...
func FindBookmark(ctx context.Context, exec boil.ContextExecutor, iD uint, selectCols ...string) (*Bookmark, error) {
...
func (o *Bookmark) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to populate default values for bookmark")
	}
...
func (o *Bookmark) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for bookmark")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to retrieve unique values for bookmark")
	}
...
func BookmarkExists(ctx context.Context, exec boil.ContextExecutor, iD uint) (bool, error) {
	var exists bool
