...
type User struct {
	...
	IsEditor    bool      `boil:"is_editor" json:"is_editor" toml:"is_editor" yaml:"is_editor"`
...
var UserWhere = struct {
	...
	IsEditor:    whereHelperbool{field: "`user`.`is_editor`"},
	...
	Displayname: whereHelperstring{field: "`user`.`displayname`"},
	Avatar:      whereHelperstring{field: "`user`.`avatar`"},
	Provider:    whereHelperstring{field: "`user`.`provider`"},
}
...
var (
	userAllColumns            = []string{"id", "is_editor", "created_at", "updated_at", "uid", "username", "displayname", "avatar", "provider"}
	userColumnsWithoutDefault = []string{"created_at", "uid", "username", "displayname", "avatar", "provider"}
	userColumnsWithDefault    = []string{"id", "is_editor", "updated_at"}
